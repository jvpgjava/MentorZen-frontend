  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-4xl font-bold text-[#9ea04f] mb-2">Sobre o Zen</h1>
      ...
      <Card className="shadow-lg border-0">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
            <i className="pi pi-heart text-[#9ea04f] text-xl"></i>
            Nossa Missão
          </h2>
      ...
      <Card className="shadow-lg border-0">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
            <i className="pi pi-users text-[#9ea04f] text-xl"></i>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full overflow-hidden shadow-lg border-4 border-[#9ea04f]">
                  <img
                    src={member.photo}
      ...
      <Card className="shadow-lg border-0">
        <div className="p-6 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
            <i className="pi pi-envelope text-[#9ea04f] text-xl"></i>
            Entre em Contato
          </h2>
          ...
          <div className="flex justify-center gap-4">
            <div className="bg-[#9ea04f] px-4 py-2 rounded-lg">
